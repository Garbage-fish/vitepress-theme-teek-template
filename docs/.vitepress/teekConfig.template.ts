...
export const teekConfig = defineTeekConfig({
    ...
    banner: {
        ...
        name: "Garbage fish", // Banner 标题，默认读取 vitepress 的 title 属性
        ...
        description: [
            ...
            "Stay awake don't fall asleep. The way is long and the gloom is deep.",
        ], // 描述信息
    ...
    //         icon: "mdi:github",
    //         name: "GitHub",
    //         link: "https://github.com/garbage-fish",
    //     },
    //     {
