...
const teekConfig = defineTeekConfig({
    ...
    author: { name: "Garbage fish", },
    blogger: {
        // 博主信息，显示在首页侧边栏
        avatar: "/img/Garbage fish.png",  //侧边栏个人头像
        shape: "circle-rotate", // 头像风格：square 为方形头像，circle 为圆形头像，circle-rotate 可支持鼠标悬停旋转
        name: "Garbage fish", // 侧边栏个人昵称
        slogan: "Man! ", // 侧边栏个人座右铭
        circleBgImg: "/img/Columbina.png", // 侧边栏个人头像圆形背景图
    ...
    //         type: "tip",
    //         title: "声明",
    //         text: `<p>作者：<a href="https://garbage-fish.top/" target="_blank" rel="noopener noreferrer">Garbage fish</a></p>
    //          <p style="margin-bottom: 0">链接：可点击右上角分享此页面复制文章链接。</p>
    //          <p>版权：本博客所有文章除特别声明外，均采用 <a href="http://www.suncai.net/PubLicense/CCBY40.html" target="_blank" rel="noopener noreferrer">CCBY-NC-SA 4.O</a> 许可协议。转载请注明来自 <a href="https://garbage-fish.top/" target="_blank" rel="noopener noreferrer">Garbage fish</a>。</p>
    //         `,
    //     };
    // },
...
export default defineConfig({
    ...
    sitemap: {
        hostname: "https://garbage-fish.top",
    ...
    themeConfig: {
        ...
        editLink: {
            text: "在 GitHub 上编辑此页",
            pattern: "https://github.com/Garbage-fish/vitepress-theme-teek/edit/main/docs/:path",
        },
    },
            ...
            AutoFrontmatter({
                ...
                transform: (frontMatter: Record<string, any>, fileInfo: FileInfo) => {
                    ...
                    const rules: TransformRule[] = [
                        { folderName: "1.algo", prefix: "/algo/$uuid5", removeLevel: 99 }, // 清空前缀并且添加前缀使用随机数
                        { folderName: "2.summary", prefix: "/summary/$uuid5", removeLevel: 99 }, // 清空前缀并且添加前缀使用随机数
                        { folderName: "3.life", prefix: "/life/$uuid5", removeLevel: 99 }, // 清空前缀并且添加前缀使用随机数
                    ];
                    // 应用规则转换
