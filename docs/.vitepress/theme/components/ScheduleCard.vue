...
const getSpringFestivalDate = (lunarYear) => {
  // 1900-2100年春节公历日期表（[月, 日]），已精准修正2026年（索引126）为[2,17]
   const springFestivalData = [
    ...
    [1, 25], [2, 12], [2, 1], [1, 22], [2, 10], [1, 29], [2, 17], [2, 6], [1, 26], [2, 13], // 2020-2029 (2026索引126为[2,17])
    [2, 3], [1, 23], [2, 11], [1, 31], [2, 19], [2, 8], [1, 28], [2, 15], [2, 4], [1, 24], // 2030-2039
    [2, 12], [2, 1], [1, 22], [2, 10], [1, 30], [2, 17], [2, 6], [1, 26], [2, 14], [2, 2],  // 2040-2049
    [1, 23], [2, 11], [2, 1], [1, 21], [2, 9], [1, 29], [2, 15], [2, 5], [1, 24], [2, 12], // 2050-2059
    [2, 2], [1, 21], [2, 9], [1, 29], [2, 17], [2, 6], [1, 26], [2, 14], [2, 3], [1, 23],  // 2060-2069
    [2, 11], [1, 31], [2, 19], [2, 8], [1, 27], [2, 15], [2, 4], [1, 24], [2, 12], [2, 1],  // 2070-2079
    [1, 22], [2, 9], [1, 29], [2, 17], [2, 6], [1, 26], [2, 14], [2, 3], [1, 23], [2, 10], // 2080-2089
    [1, 30], [2, 18], [2, 8], [1, 27], [2, 15], [2, 5], [1, 25], [2, 13], [2, 2], [1, 21], // 2090-2099
    [2, 9] // 2100
  ];
